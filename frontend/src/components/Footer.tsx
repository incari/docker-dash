                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
                        <div className="flex flex-col items-center sm:items-start gap-1.5 sm:gap-2">
                            <p className="text-slate-400 text-xs sm:text-sm flex items-center gap-1.5 whitespace-nowrap">
                                {t("footer.madeWith")} <BatteryCharging className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-yellow-300 fill-text-emerald-500/20" /> {t("footer.by")} <span className="text-slate-200 font-medium">Incari</span>
                            </p>
